...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      testimonials={[
        {
          ...
          testimonial: "En rigtig dygtig tømrer",
          rating: 5,
        ...
        },
        {
          name: "Audrone C.",
          handle: "Google Reviews",
          testimonial: "Super service og rigtig god kundeservice.",
          rating: 5,
        ...
        },
        {
          name: "Jens Jensen",
          handle: "Google Reviews",
          testimonial: "Hurtig respons og fantastisk resultat.",
          rating: 5,
        ...
        },
        {
          name: "Mette M.",
          handle: "Google Reviews",
          testimonial: "Professionel hele vejen igennem.",
          rating: 5,
        ...
        },
        {
          name: "Peter H.",
          handle: "Google Reviews",
          testimonial: "Vi er meget tilfredse med vores nye tag.",
          rating: 5,
      ...
      buttons={[
        {
          text: "Få et uforpligtende tilbud",
          href: "#contact",
        },
        {
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/male-carpenter-standing-workbench-using-mobile-phone_23-2147944903.jpg",
          alt: "Kunde 1",
        },
        {
          src: "http://img.b2bpic.net/free-photo/professional-carpenter-checking-smoothness-wood-product-workshop_342744-828.jpg",
          alt: "Kunde 2",
        },
        {
          src: "http://img.b2bpic.net/free-photo/professional-smiling-middle-aged-carpenter-holding-wood-plank-woodworking-workshop_342744-811.jpg",
          alt: "Kunde 3",
        },
        {
          src: "http://img.b2bpic.net/free-photo/construction-worker-using-hammer-job-site_23-2150530709.jpg",
          alt: "Kunde 4",
        },
        {
  ...
  <div id="about" data-section="about">
      ...
      title="Når dit hjem fortjener det bedste"
      buttons={[
        {
      ...
      metrics={[
        {
          id: "m1",
          value: "100%",
          description: "Personlig dialog",
        },
        {
          id: "m2",
          value: "5*",
          description: "Kvalitetsbedømmelse",
        },
        {
          id: "m3",
          value: "Fast",
          description: "Prisgaranti",
        },
        {
          id: "m4",
          value: "Altid",
          description: "Tidsoverholdelse",
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      testimonials={[
        ...
        },
        {
          id: "t2",
          name: "Audrone C.",
          imageSrc: "http://img.b2bpic.net/free-photo/photorealistic-wooden-house-interior-with-timber-decor-furnishings_23-2151263513.jpg",
        },
        {
          id: "t3",
          name: "Jens Jensen",
  ...
  <div id="gallery" data-section="gallery">
      ...
      products={[
        ...
        },
        {
          ...
          rating: 5,
          reviewCount: "1",
          imageSrc: "http://img.b2bpic.net/free-photo/smiling-carpenter-measuring-wooden-planks_329181-3745.jpg",
        },
        {
          id: "g3",
          brand: "Udendørs",
        ...
        },
        {
          id: "g5",
          brand: "Indendørs",
          name: "Kvalitets finish",
          price: "Snedkerfinish",
          rating: 5,
          reviewCount: "1",
          imageSrc: "http://img.b2bpic.net/free-photo/man-making-surfboard_107420-94947.jpg",
        },
        {
          id: "g6",
          brand: "Tilbygning",
          ...
          rating: 5,
          reviewCount: "1",
          imageSrc: "http://img.b2bpic.net/free-photo/flat-lay-construction-engineer-equipment-with-copyspace_23-2148233698.jpg",
        },
      ]}
